 ...
 */
package com.fluxtion.server.service.pool;

import com.fluxtion.server.service.pool.impl.PoolTracker;


/**
 * Interface for objects that can be managed by an {@link com.fluxtion.server.service.pool.ObjectPool}.
 ...
 *
 * @see com.fluxtion.server.service.pool.ObjectPool
 * @see PoolTracker
 */
