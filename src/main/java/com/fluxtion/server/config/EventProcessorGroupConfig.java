...
public class EventProcessorGroupConfig {
    ...
    public static final class Builder {
        ...
        public Builder logLevel(EventLogControlEvent.LogLevel logLevel) { this.logLevel = logLevel; return this; }
        public Builder eventHandlers(Map<String, EventProcessorConfig<?>> handlers) { this.eventHandlers = handlers; return this; }
