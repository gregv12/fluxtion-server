...
import com.fluxtion.server.service.error.ErrorEvent;
import com.fluxtion.server.service.error.ErrorReporter;
import com.fluxtion.server.service.error.ErrorReporting;
...
public class EventToQueuePublisherAdditionalTest {
    ...
    static class CapturingReporter implements ErrorReporter {
        ...
        @Override public void addListener(com.fluxtion.server.service.error.ErrorListener listener) { }
        @Override public void removeListener(com.fluxtion.server.service.error.ErrorListener listener) { }
    ...
    void clearReporter() {
        ...
        ErrorReporting.setReporter(new com.fluxtion.server.service.error.DefaultErrorReporter());
    }
